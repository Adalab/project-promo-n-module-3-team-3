					...
					<form
						...
						<fieldset>
							<div
								...
								<i
									className={`fas ${arrow} arrow js_arrow`}></i>
							</div>

							<div
								className={`js_content div_content ${collapsableDesign}`}>
						...
						<fieldset>
							<div
								...
								<i
									className={`fas ${arrow2} arrow js_arrow`}></i>
							</div>

							<div
								className={`js_content div_content ${collapsableFill}`}>
						...
						<fieldset>
							<div
								...
								<i
									className={`fas ${arrow3} arrow js_arrow`}></i>
							</div>
